...
Partial Class UserControl1
    ...
    Private Sub InitializeComponent()
        ...
        Me.ImageList1.Images.SetKeyName(0, "pngtree-cherry-fresh-ripe-green-leaf-fruit-png-image_3328184.jpg")
        Me.ImageList1.Images.SetKeyName(1, "7.jpg")
        Me.ImageList1.Images.SetKeyName(2, "Lemon.jpg")
        '
        'UserControl1
        '
